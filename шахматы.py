...
print("Поля (k, l) и (m, n) являются полями одного цвета:", is_same_color(k, l, m, n))
print("Фигура угрожает полю (m, n):", is_threatened(k, l, m, n, figure))
print("Фигура может попасть на поле (m, n) одним ходом:", can_reach(k, l, m, n, figure))